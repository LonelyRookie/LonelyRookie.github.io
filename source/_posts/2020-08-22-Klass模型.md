...
{% asset_img 2020-08-18_232019.png  %}
...
{% asset_img 2020-08-19_002550.png  %}
...
{% asset_img 2020-08-19_002356.png  %}



启动后的HSDB：

{% asset_img 2020-08-19_002850.png  %}

点击Attach to HotSpot process 输入Test_1的进程ID 23304

{% asset_img 2020-08-19_003103.png  %}



输入进程ID后：

{% asset_img 2020-08-19_003419.png  %}



点击Class Browser：查这个进程的所有类

{% asset_img 2020-08-19_003534.png  %}



可以看到Test_1的内存地址：

{% asset_img 2020-08-19_003713.png  %}

点击Inspector，输入Test_1的内存地址 0x0000000100060828

{% asset_img 2020-08-19_004002.png  %}



可以看到InstanceKlass

{% asset_img 2020-08-19_004223.png  %}
...
{% asset_img 2020-08-19_230212.png  %}
...
{% asset_img 2020-08-19_231632.png  %}
...
{% asset_img 2020-08-19_233627.png  %}
...
{% asset_img 2020-08-19_235227.png  %}
