...
![](/images/2020-10-26/2020-10-18_145817.png)
...
![](/images/2020-10-26/2020-10-18_130911.png)
...
![](/images/2020-10-26/2020-10-18_131219.png)
...
ArrayList、HashMap中都有一个属性叫`modCount`，每次对集合的修改这个值都会加1，在遍历前记录这个值到`expectedModCount`中，遍历中检查两者是否一致，如果出现不一致就说明有修改，则抛出ConcurrentModificationException异常。
