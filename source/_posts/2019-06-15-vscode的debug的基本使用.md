...
{% asset_img chrome201906151628.PNG Debugger For Chrome %}

第二步，打开vscode调试区域，然后点设置

{% asset_img 2019-06-15_163020.png vscode调试区域 %}

 然后，选Chrome

{% asset_img 2019-06-15_163321.png Chrome配置 %}
...
{% asset_img 2019-06-15_164522.png debug运行 %}

chrome自动启动的结果

{% asset_img 2019-06-15_170804.png 启动结果 %}

我们在index.html里面随便写点js，然后重新启动。console.log()在vscode里面显示出来了

{% asset_img 2019-06-15_171755.png 调试结果 %}

### 断点调试

我们在vscode里面加断点，进行单步调试。在index.html里面写的js代码不可以打断点，所以把js代码放到js文件中，引入index,js到index.html中

{% asset_img 2019-06-15_173151.png 断点调试1 %}

{% asset_img 2019-06-15_173408.png 断点调试2 %}
...
{% asset_img 2019-06-15_225249.png chrome启动项配置 %}
...
{% asset_img 2019-06-16_001833.png 设置断点 %}
...
{% asset_img 2019-06-15_235645.png Vue.js devtools %}
...
{% asset_img 2019-06-16_002604.png Vue Devtools %}
...
{% asset_img 2019-06-16_003306.png 谷歌访问助手 %}

### 简单的 debugger 语句

你可以直接在代码中使用原生的 debugger 语句。如果你选择了这种方式，请千万记得当你调试完毕之后把这个语句移除。

{% asset_img 2019-06-16_000110.png debugger语句 %}
